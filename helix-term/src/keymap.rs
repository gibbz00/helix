...
impl KeyTrieNode {
    ...
    pub fn infobox(&self) -> Info {
        ...
        for (&key, trie) in self.iter() {
            ...
            // Check if the description exists if it does, append key to KeyEventSet
            // This is why the diffent multiple command sequences will look as if they trigger the same command 
